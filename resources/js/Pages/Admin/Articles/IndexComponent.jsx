                        ...
                        <tr key={article.id}>
                            ...
                            <td>
                                <form form id={`updateForm-${article.id}`} onSubmit={(e) => e.preventDefault()}>
                                    ...
                                    <input className="hidden" name="is_active" type="text" defaultValue={article.is_active === 1 ? 0 : 1} />
                                    <button
                                        type="submit"
                            ...
                            <td className="buttons">
                                <Link to={`/admin/articles/edit/${article.id}`} state={{
                                    id: article.id
                                }}>
                                ...
                                <button className="btn btn-danger" onClick={() => deleteArt(article.id)}>
                                        Delete
                                </button>
                            </td>
                        </tr>
